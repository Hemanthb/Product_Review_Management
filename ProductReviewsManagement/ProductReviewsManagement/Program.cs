...
List<ProductReviewsManagement.ProductReview> reviews = new List<ProductReviewsManagement.ProductReview>()
{
    ...
    new ProductReviewsManagement.ProductReview() { ProductId = 5, UserId = 10, Rating = 4, Review = "Good", isLike = true },
    new ProductReviewsManagement.ProductReview() { ProductId = 10, UserId = 23, Rating = 5, Review = "Excelent", isLike = false },
