Console.WriteLine("Enter your choice\n\t1 - To Fetch Top 3 High rated records\n\t" +
    ...
    "10 - Products with review is Nice\n\t11 - Records having user Id as 10\n");
...
switch (choice)
{
    ...
    case 5:
        ...
        break;
    case 6:
        reviewsManagement.ProductIDAndReviewUsingSelectLINQ(reviews);
        break;
    case 7:
        reviewsManagement.createDatatable(reviews);
        break;
    case 8:
        reviewsManagement.IsLikeValueTrue(reviews);
        break;
    case 9:
    ...
    case 10:
        ...
        break;
    case 11:
        reviewsManagement.RecordsForUserID10(reviews);
        break;
}
